...
public class DetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView imageView = findViewById(R.id.dimageView);
        TextView rating_tv = findViewById(R.id.drating_id);
        TextView title_tv = findViewById(R.id.dmovie_id);
        TextView overview_tv = findViewById(R.id.doverview_id);
